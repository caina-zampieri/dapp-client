...
const flipCard = (state = INITIAL_STATE, action) => {
    ...
    return state.merge({...state,
            ...
            cardsChosen: [...state.cardsChosenId, cardId]
        })
}

const clearChosenCards = (state = INITIAL_STATE, action) => state.merge({...state, cardsChosen: [], cardsChosenId: []})

const setWonCard = (state = INITIAL_STATE, action) => state.merge({...state, cardsWon: [...state.cardsWon, action.optionOneId, action.optionTwoId]})
